...
class User extends Authenticatable
{
    ...
    public function voteQuestion(Question $question, $vote) 
    {
        ...
        $question->load('votes');
        $downVotes = (int) $question->downVotes()->wherePivot('vote',-1)->sum('vote');
    ...
    public function voteAnswer(Answer $answer, $vote) 
    {
        ...
        $answer->load('votes');
        $downVotes = (int) $answer->downVotes()->wherePivot('vote',-1)->sum('vote');
        $upVotes = (int) $answer->upVotes()->wherePivot('vote',1)->sum('vote');
